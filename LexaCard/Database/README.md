...
```sql
CREATE DATABASE lexacard;
```

### 3. Rulează scriptul init
În pgAdmin → Query Tool pe baza `lexacard`:
...
```
LexaCard/Resources/Images/images/
```
...
## Connection String
In `LexaCard.Data/Context/LexaDbContext.cs`:
```csharp
